...
always match the dataset it actually trained on.
"""
...
def _write_capture(repository, tmp_path, capture_id, data_origin, examples_per_session=4, samples_per_example=800, sample_rate=4_000_000.0):
    ...
    capture = CaptureRecord(
        project_id="P1", campaign_id="C1", capture_id=capture_id, session_id=f"S-{capture_id}", execution_id=f"E-{capture_id}",
